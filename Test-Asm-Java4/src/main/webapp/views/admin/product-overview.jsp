...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	function deleteVideo(href) {
		$.ajax({
			url: '/Test-Asm-Java4-BanHang/admin/product?action=delete&id=' + href
		}).done(function() {
			window.location.href = "<c:url value='/admin/product?action=view'/>"; // Sử dụng c:url để giữ đường dẫn tương đối
		}).fail(function() {
